...
function HorList() {
    ...
    return (
        <View style={styles.container}>
            <Text style={{ color: '#000000', fontSize: 20, fontWeight: 'bold', marginVertical: 10, }}>Popular Food</Text>
            <FlatList
                horizontal
                data={menu}
                ...
                renderItem={({ item }) => (
                    <View style={{
                        ...
                        <View style={{ flex: 0.2, width: '100%' }}>
                            <View style={{ flex: 0.5, flexDirection: 'row', }}>
                                ...
                                <View style={{ flex: 0.5, flexDirection: 'row', justifyContent: 'flex-end' }}>
                                    <Image style={styles.star} source={require("./assets/favorite.png")} />
                                </View>
                            </View>
                        </View>
                        <View style={{ flex: 0.5 }}>
                        ...
                        <View style={{ flex: 0.3 }}>
                            <View style={{ flex: 0.5 }}>
                                <Text style={{ color: '#000000', fontSize: 20, fontWeight: 'bold', marginVertical: 5, }}>{item.name}</Text>
                            </View>
                            <View style={{ flex: 0.5, alignItems: 'center', justifyContent: 'center' }}>
                                <Text style={{ color: '#383F53', fontSize: 14, }}>${item.price}</Text>
                            </View>
                        </View>
                    </View>
                )
